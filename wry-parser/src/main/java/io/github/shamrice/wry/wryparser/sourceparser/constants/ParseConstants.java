...
public class ParseConstants {
    public static final String CHOICE_REGEX_PATTERN = "^[0-9].*\\).*";
    public static final String GAME_OVER_SUB_NAME = "Gameover";
    public static final String STORY_SUB_NAME2 = "gameselect2";
    public static final String STORY_SUB_NAME1 = "gameselect";
    public static final String TITLE_SCREEN_SUB_NAME = "title";
    public static final String TITLE_SCREEN_DEST_NAME = "TITLE_SCREEN";
    ...
    public static final String THEN_COMMAND = "THEN";
    public static final String ELSE_COMMAND = "ELSE";
    public static final String CASE_COMMAND = "CASE";
    public static final String SELECT_COMMAND = "SELECT";
    public static final String SUB_COMMAND = "SUB";
    public static final String END_SUB_COMMAND = "END SUB";
